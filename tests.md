...
010) Javascript Compatibility Tests
  ...
  150) Error Handling Tests
    ...
    Operator OpError Reporting
      ✔ should report from every expression operator which rejects its argument (189ms)
      ✔ should report from every update operator which rejects its argument (22ms)
      ✔ should report from every accumulator which rejects its argument (19ms)
      ✔ should report from every stage which rejects its argument (32ms)
      ✔ should report from the query operators which reject their argument (46ms)
  ...
  250) Update Operator Tests
    Field Update Operator Tests
      ...
      $currentDate Tests
        ...
        ✔ should report an invalid date specification and fail (8ms)
    ...
    Aggregate Tests
      ...
      Date Operator Tests
        Reading the Parts of a Date
          ✔ should read the year with $year (20ms)
