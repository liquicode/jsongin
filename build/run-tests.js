...
/*
	Runs the unit tests and the jsongin parity tests as two separate mocha
	...
	The parity suites need no server (jsongin-Tests.js runs the shared inventory
...
const SUITES = [
	...
	{ label: 'Parity Tests', files: [ 'test/Parity Tests/jsongin-Tests.js' ] },
];
