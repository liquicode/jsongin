...
<!-- Note: these links are root-absolute on purpose.
     The site runs with docsify's relativePath enabled, which would otherwise
     resolve a sidebar link against whichever page is currently open. -->
...
- Work with Data Types
	...
	- [`BsonType()`](/guides/jsongin/BsonType.md)
	- [`AsNumber()`](/guides/jsongin/AsNumber.md)
