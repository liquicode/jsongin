...
module.exports = function ( Engine )
{
	function SplitPath( Path )
	{
		...
		{
			if ( Engine.OpLog ) { Engine.OpLog( `SplitPath: Path is invalid [${Path}].` ); }
			return null;
		}
		...
		while ( path_index < path_elements.length )
		{
			...
			if ( name === '' )
			{
				if ( Engine.OpLog ) { Engine.OpLog( `SplitPath: Path cannot contain empty elements in [${Path}].` ); }
				return null;
			}
			...
			// 		// {
			// 		// 	if ( Engine.OpLog ) { Engine.OpLog( `SplitPath: Path cannot start with the $ root element without path extensions in [${Path}].` ); }
			// 		// 	return null;
			// 		// }
			...
			// 	else
			// 	{
			// 		if ( Engine.OpLog ) { Engine.OpLog( `SplitPath: Cannot contain the $ element within path [${Path}].` ); }
			// 		return null;
			// 	}
			// }
			...
			// 	{
			// 		if ( Engine.OpLog ) { Engine.OpLog( `SplitPath: A non-numeric array index [${array_index}] was found in [${Path}].` ); }
			// 		return null;
			// 	}
